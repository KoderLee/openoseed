 ...
 *  
 */
package org.openo.sdno.svc.vpn.composedvpn.nbi.te.service.inf;
...
public interface TeServiceIf extends IService {

    RestRsp<List<TePathList>> getComposedVpnTePath(TePathQueryVo tePathQueryVo) throws ServiceException;

    RestRsp<List<NetworkElementMO>> getTpNetworkElements(final String tpNeIds, HttpContext httpContext)
