...
public class ErrorResMgr {
    ...
    /**
     * Interface to the the single instance object of ErrorResMgr type.<br/>
     * 
     * @return ErrorResMgr instance object
     * @since SDNO 0.5
     */
     ...
     * <br/>
     * <p>
     * Gets a Locale specific error message for a given input key as string defined in the
     * properties file
     * </p>
     * 
     * @param key input key
