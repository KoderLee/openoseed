...
/**
 * Current support for full-mesh and point_to_multipoint(hub-spoke), others is reserved for future
 * extensions.<br/>
 * 
 * @author
...
public enum TopologyType implements CommonName {
    FULL_MESH("full-mesh"), POINT_TO_MULTIPOINT("point_to_multipoint"), POINT_TO_POINT("point_to_point"), COMPLEX(
            "complex");
