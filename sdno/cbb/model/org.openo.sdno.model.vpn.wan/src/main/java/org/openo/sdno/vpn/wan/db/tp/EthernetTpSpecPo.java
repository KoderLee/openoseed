...
@MOResType(infoModelName = "wan_ethernettpspec")
public class EthernetTpSpecPo implements PoModel<EthernetTpSpec> {
    ...
    /**
     * Inner VLAN ID list. Can auto assignment from resource pools. This is a string table.
     */
    ...
    @Override
    public void fromSvcModel(EthernetTpSpec svcModel) {
