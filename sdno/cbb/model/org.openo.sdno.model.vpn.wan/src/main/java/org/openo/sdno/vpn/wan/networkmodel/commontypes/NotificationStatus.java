...
public enum NotificationStatus {
    ...
    public static int getIntValueByName(String nameStr) {
        if(NotificationStatus.UP.getName().equals(nameStr)) {
            return NotificationStatus.UP.getValue();
        }

        if(NotificationStatus.DOWN.getName().equals(nameStr)) {
            return NotificationStatus.DOWN.getValue();
        }
