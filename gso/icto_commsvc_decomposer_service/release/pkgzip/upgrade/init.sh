...
DB_ID="servicedecomposerdb"
SCRIPT=$APP_ROOT/init/tables_@{dbtype}.sql
SCRIPTEXT=$ICTO_COM_SDK_PATH/init/tables_@{dbtype}.sql
...
JVM_OPT="$JVM_OPT -Dinit.scriptExt=$SCRIPTEXT"
JVM_OPT="$JVM_OPT -Dinit.connectType=$1"
JVM_OPT="$JVM_OPT -Dinit.class=com.huawei.icto.commsvc.inittool.init.impl.DBInitializer"
...
$ICTO_COM_SDK_PATH/com.huawei.icto.commsvc.inittool-1.0.0-SNAPSHOT.jar:\
$THIRD_PART_PATH/lib/*"
JVM_OPT="$JVM_OPT -classpath $CLASS_PATH"

$JAVA $JVM_OPT com.huawei.icto.commsvc.inittool.InitTool
result=$?
